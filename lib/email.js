  ...
  return getResend().emails.send({
    ...
    html: shell(
      ...
      `<table style="width:100%;border-collapse:collapse;font-size:14px;margin-bottom:16px;">${rows}</table>
       ...
       <p style="white-space:pre-wrap;color:#f3f5f7;background:#12141a;border:1px solid #262a35;border-radius:12px;padding:14px;">${esc(app.pitch)}</p>
