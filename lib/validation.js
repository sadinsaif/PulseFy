...
export const reviewSchema = z.object({
  ...
  // Rate is computed in-app as engagement / views * 100.
  views: z.coerce.number().int().min(0).max(1000000000).optional(),
  engagement: z.coerce.number().int().min(0).max(1000000000).optional(),
});
